...
class OPENEYE:
    ...
    def search(username, Mode):
        ...
        if opt == 1:
            ...
            OPENEYE.Controll(username, nomefile, identity, report, subject,
            ...
            Nsfw = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Username", "Default", "Nsfw") +
                    Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
            if Nsfw == 1:
            ...
            OPENEYE.Scraping(report,username,http_proxy,InstagramParams,PostLocations, PostGpsCoordinates,TwitterParams)
        ...
        Recaps = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                filename, "Default", "Hypo", "None") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if Recaps == 1:
            if opt == 1:
        ...
        if count == 1:
            ...
            if choice == 1:
                OPENEYE.Google_dork(username)
                OPENEYE.Yandex_dork(username)
