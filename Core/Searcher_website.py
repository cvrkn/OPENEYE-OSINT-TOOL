...
class Web:
    ...
    def Profiles(username,report):
        ...
        print("-------------------------------------------------------------------------------------------------------------------------------------")
        choice = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Robots") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
            Web.Robots(username, report)
        else:
            choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Ports") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
                Web.Ports(username, report)
            else:
                choice = int(input(
                    Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Traceroute") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
    ...
    def Reputation(username, report):
        ...
        sc = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Default", "choice", "None") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if sc == 1:
        ...
        for sites in data:
            ...
            f.close()
            choice = int(input(
                    Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Soc") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
    ...
    def google_dork(username, number, num, email, email2):
        ...
        choice = int(input(
            Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Repu") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
    ...
    def whois_lookup(username, report, Mode):
        ...
        if Key == "None":
            ...
            try:
                ...
                pass
        choice = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Default", "Dorks", "None") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
    ...
    def search(username, Mode):
        ...
        choice = int(input(
            Font.Color.BLUE + " \n[+]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Website", "Questions", "Whois") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
        ...
        choice = int(input(
            Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Transfer", "Question", "None") + Font.Color.GREEN + "[#OPENEYE#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
